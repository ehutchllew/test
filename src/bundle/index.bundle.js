...
=======
>>>>>>> 024ccfa89e22fd2efcd47be68b3d1c4e37d5c520:src/bundle/index.bundle.js
    ...
    var events = {
      ...
      hamburgerMenu: function hamburgerMenu() {
        ...
        $theMenu.find('div').on('click', function () {
          ...
          //console.log($(`.main #${menuId}`).parent().find('.drop-container'));
          if ($('.main #' + menuId).parent().find('.drop-container').hasClass('dropdown')) $('html, body').animate({ scrollTop: $('.main #' + menuId).parent().offset().top }, 550);else $('.main #' + menuId).click();
        });
      },
      ...
      dropdownMenus: function dropdownMenus() {
        ...
        $mainSub.on('click', function () {
          var $parentElement = $(this).parent();
          var $dropContainer = $parentElement.find('.drop-container');

          $dropContainer.toggleClass('dropdown');
          $parentElement.find('.rowz').toggleClass('dropdown');
          $parentElement.find('.item').toggleClass('dropdown');

          if ($dropContainer.hasClass('dropdown')) $('html, body').animate({ scrollTop: $parentElement.offset().top }, 550);
        });
      }
